...
export function RecruitmentApplicationsOverviewPage() {
  ...
  const [withdrawnAdmissions, setWithdrawnAdmissions] = useState<RecruitmentApplicationDto[]>([]);
  ...
  function withdrawnAdmissionToTableRow(admission: RecruitmentApplicationDto) {
    return [
      {
