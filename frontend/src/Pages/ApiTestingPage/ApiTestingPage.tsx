  ...
  return (
    <div className={styles.wrapper}>
      <Button
        ...
        onClick={() => getCsrfToken().then(console.log).catch(console.error)}
      >
        getCsrfToken
      </Button>
      <Button
      ...
      <Button theme="primary" className={styles.btn} onClick={() => logout().then(console.log).catch(console.error)}>
        logout
      </Button>
      <Button theme="primary" className={styles.btn} onClick={() => getUser().then(console.log).catch(console.error)}>
        getUser
      </Button>
      <Button theme="primary" className={styles.btn}>
        putUserPreference
      </Button>
      <Button theme="primary" className={styles.btn} onClick={() => getVenues().then(console.log).catch(console.error)}>
        getVenues
      </Button>
      <Button theme="primary" className={styles.btn} onClick={() => getVenue(1).then(console.log).catch(console.error)}>
        getVenue
      </Button>
      <Button
        theme="primary"
