      ...
      <div className={styles.container}>
        ...
        {user ? (
          ...
          >
            ...
            <SamfFormField field="file" type="file" props={{existing_url: 'www.google.com'}} />
            <SamfFormField field="file" type="upload_image" />
            <SamfFormField field="file" type="upload_pdf" />
          </SamfForm>
        ) : (
          <div>
            <Button
