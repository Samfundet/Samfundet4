...
export const nb = prepareTranslations({
  ...
  [KEY.recruitment_applet_statistics_description]: 'Se statistikk for dette opptaket',
...
export const en = prepareTranslations({
  ...
  [KEY.recruitment_applet_statistics_description]: 'See statistics for this recruitment',
