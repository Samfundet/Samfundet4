...
export const nb = prepareTranslations({
  ...
  [KEY.admin_closed_period_end_before_start]: 'Slutt dato må være etter start dato',
  [KEY.admin_closed_period_end_before_today]: 'Slutt dato må være før dagens dato',
...
export const en = prepareTranslations({
  ...
  [KEY.admin_closed_period_end_before_today]: 'End date must be before today',
