...
export const nb = prepareTranslations({
  ...
  [KEY.admin_site_banner_title]: 'Administrer sidebanner',
  [KEY.admin_site_banner_new]: 'Legg til nytt sidebanner',
  [KEY.admin_site_banner_edit]: 'Endre sidebanner',
  [KEY.admin_site_banner_confirm_delete]: 'Er du sikker på at du vil slette dette sidebanneret?',
  [KEY.admin_site_banner_end_after_start]: 'Sluttid må være etter starttid.',
...
export const en = prepareTranslations({
  ...
  [KEY.admin_site_banner_title]: 'Manage site banners',
  [KEY.admin_site_banner_new]: 'Add new site banner',
  [KEY.admin_site_banner_edit]: 'Edit site banner',
  [KEY.admin_site_banner_confirm_delete]: 'Are you sure you want to delete this site banner?',
  [KEY.admin_site_banner_end_after_start]: 'End time must be after start time.',
