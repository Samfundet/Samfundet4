...
export const nb = prepareTranslations({
  ...
  [KEY.event_form_end_dt_before_start_dt]: 'Sluttidspunkt kan ikke være før starttidspunkt',
...
export const en = prepareTranslations({
  ...
  [KEY.event_form_end_dt_before_start_dt]: 'End time cannot be before start time',
