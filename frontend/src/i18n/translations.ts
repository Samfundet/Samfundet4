...
export const nb = prepareTranslations({
  ...
  [KEY.common_closed]: 'Stengt',
  [KEY.common_default]: 'Standard',
  ...
  [KEY.admin_closed_period_end_before_start]: 'slutt må være etter start',
  [KEY.admin_closed_period_end_before_today]: 'slutt kan ikke være før dagens dato',
...
export const en = prepareTranslations({
  ...
  [KEY.common_closed]: 'Closed',
  [KEY.common_default]: 'Default',
  ...
  [KEY.admin_closed_period_end_before_start]: 'end must be after start',
  [KEY.admin_closed_period_end_before_today]: 'end cannot be before today',
