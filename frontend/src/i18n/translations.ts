...
export const nb = prepareTranslations({
  ...
  [KEY.admin_site_banner_title]: 'Opprett nettsidebanner',
  [KEY.admin_site_banner_description]:
    'Banneret vises øverst på alle Samfundets nettsider i det valgte tidsrommet. Hvis flere bannere er aktive samtidig, vises det som startet sist.',
  [KEY.admin_site_banner_text_hint]: 'Maks 128 tegn.',
  [KEY.admin_site_banner_url]: 'Lenke (valgfritt)',
  [KEY.admin_site_banner_url_hint]: 'Bruk en intern sti, for eksempel /events/, eller en fullstendig HTTP(S)-adresse.',
  [KEY.admin_site_banner_new_tab]: 'Åpne lenken i en ny fane',
  [KEY.admin_site_banner_new_tab_hint]: 'Gjelder bare når banneret har en lenke.',
  [KEY.admin_site_banner_start_at]: 'Vis fra',
  [KEY.admin_site_banner_start_at_hint]: 'Tidspunktet banneret skal bli synlig.',
  [KEY.admin_site_banner_end_at]: 'Vis til',
  [KEY.admin_site_banner_end_at_hint]: 'Tidspunktet banneret skal fjernes automatisk.',
  [KEY.admin_site_banner_preview]: 'Forhåndsvisning',
  [KEY.admin_site_banner_preview_placeholder]: 'Bannerteksten vises her',
  [KEY.admin_site_banner_validation_url]: 'Skriv inn en intern sti eller en gyldig HTTP(S)-adresse.',
  [KEY.admin_site_banner_validation_end]: 'Sluttidspunktet må være etter starttidspunktet.',
...
export const en = prepareTranslations({
  ...
  [KEY.admin_site_banner_title]: 'Create site banner',
  [KEY.admin_site_banner_description]:
    'The banner appears above every Samfundet page during the selected period. If several banners are active at once, the most recently started banner is shown.',
  [KEY.admin_site_banner_text_hint]: 'Maximum 128 characters.',
  [KEY.admin_site_banner_url]: 'Link (optional)',
  [KEY.admin_site_banner_url_hint]: 'Use an internal path, such as /events/, or a complete HTTP(S) address.',
  [KEY.admin_site_banner_new_tab]: 'Open the link in a new tab',
  [KEY.admin_site_banner_new_tab_hint]: 'Only applies when the banner has a link.',
  [KEY.admin_site_banner_start_at]: 'Show from',
  [KEY.admin_site_banner_start_at_hint]: 'The time when the banner becomes visible.',
  [KEY.admin_site_banner_end_at]: 'Show until',
  [KEY.admin_site_banner_end_at_hint]: 'The time when the banner is removed automatically.',
  [KEY.admin_site_banner_preview]: 'Preview',
  [KEY.admin_site_banner_preview_placeholder]: 'Banner text appears here',
  [KEY.admin_site_banner_validation_url]: 'Enter an internal path or a valid HTTP(S) address.',
  [KEY.admin_site_banner_validation_end]: 'The end time must be after the start time.',
