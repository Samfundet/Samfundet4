...
export const nb = prepareTranslations({
  ...
  [KEY.admin_closed_period_end_before_start]: 'end må være etter start',
  ...
  [KEY.admin_closed_period_closing_status]: 'Stenging status',
...
export const en = prepareTranslations({
  ...
  [KEY.admin_closed_period_closing_status]: 'Closing status',
