...
export const nb = prepareTranslations({
  ...
  [KEY.recruitment_application_for_position]: 'Søknad på stilling',
  ...
  [KEY.recruitment_your_priority]: 'Søknads prioritering',
...
export const en = prepareTranslations({
  ...
  [KEY.recruitment_your_priority]: 'Application priority',
