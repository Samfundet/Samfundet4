...
export const nb = prepareTranslations({
  ...
  [KEY.recruitment_interview_group_create_header]: 'Opprett stillingsgruppe for felles intervju',
  [KEY.recruitment_interview_group_edit_header]: 'Endre stillingsgruppe for felles intervju',
  [KEY.recruitment_search_position]: 'Søk på stillingstittel',
...
export const en = prepareTranslations({
  ...
  [KEY.recruitment_interview_group_create_header]: 'Create group for shared interview',
  [KEY.recruitment_interview_group_edit_header]: 'Edit group for shared interview',
  [KEY.recruitment_search_position]: 'Search for position',
