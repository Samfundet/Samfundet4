...
export const KEY = {
  ...
  billig_callback_failure_title: 'billig_callback_failure_title',
  billig_callback_failure_lead: 'billig_callback_failure_lead',
  billig_callback_error_heading: 'billig_callback_error_heading',
  billig_callback_retry_heading: 'billig_callback_retry_heading',
  billig_callback_retry_lead: 'billig_callback_retry_lead',
  billig_callback_signed_retry_lead: 'billig_callback_signed_retry_lead',
  billig_callback_editable_retry_heading: 'billig_callback_editable_retry_heading',
  billig_callback_editable_retry_lead: 'billig_callback_editable_retry_lead',
  billig_callback_non_retryable_heading: 'billig_callback_non_retryable_heading',
  billig_callback_non_retryable_description: 'billig_callback_non_retryable_description',
  billig_callback_missing_error_session: 'billig_callback_missing_error_session',
  billig_callback_back_heading: 'billig_callback_back_heading',
  billig_callback_back_to_event: 'billig_callback_back_to_event',
  billig_callback_back_to_events: 'billig_callback_back_to_events',
