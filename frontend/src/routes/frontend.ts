export const ROUTES_FRONTEND = {
  ...
  admin_recruitment_statistics: '/control-panel/recruitment/statistics/',
  admin_current_recruitment_statistics: '/control-panel/recruitment/:recruitmentId/statistics/',
