...
export const ROUTES_BACKEND = {
  ...
  samfundet__menu_list: '/sulten/api/menu/',
  samfundet__menu_detail: '/sulten/api/menu/:pk/',
  samfundet__menu_items_list: '/sulten/api/menu-items/',
  samfundet__menu_items_detail: '/sulten/api/menu-items/:pk/',
  samfundet__food_preference_list: '/sulten/api/food-preference/',
  samfundet__food_preference_detail: '/sulten/api/food-preference/:pk/',
  samfundet__food_category_list: '/sulten/api/food-category/',
  samfundet__food_category_detail: '/sulten/api/food-category/:pk/',
