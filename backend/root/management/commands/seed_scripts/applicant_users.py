...
FIRST_NAMES = [
    'Emma', 'Jakob', 'Nora', 'Filip', 'Ella', 'Oliver', 'Maja', 'William', 'Sofie', 'Liam',
    'Olivia', 'Noah', 'Leah', 'Theodor', 'Ingrid', 'Aksel', 'Sofia', 'Emil', 'Emilie', 'Lucas',
    'Sara', 'Mathias', 'Anna', 'Matheo', 'Linnea', 'Henrik', 'Thea', 'Johan', 'Amalie', 'Oscar',
    'Julie', 'Isak', 'Hanna', 'Jonas', 'Vilde', 'Magnus', 'Aurora', 'Sebastian', 'Ida', 'Daniel',
    'Marie', 'Elias', 'Hedda', 'Alexander', 'Eva', 'Benjamin', 'Oda', 'Kristian', 'Mia', 'Andreas'
]

# Common Norwegian last names for realistic test data
LAST_NAMES = [
    'Hansen', 'Johansen', 'Olsen', 'Larsen', 'Andersen', 'Pedersen', 'Nilsen', 'Kristiansen',
    'Jensen', 'Karlsen', 'Johnsen', 'Pettersen', 'Eriksen', 'Berg', 'Haugen', 'Hagen', 'Jacobsen',
    'Lund', 'Halvorsen', 'Sørensen', 'Jakobsen', 'Moen', 'Gundersen', 'Iversen', 'Strand',
    'Solberg', 'Martinsen', 'Paulsen', 'Knutsen', 'Eide', 'Bakken', 'Kristoffersen', 'Mathisen',
    'Lie', 'Amundsen', 'Nguyen', 'Ruud', 'Holm', 'Lunde', 'Svendsen', 'Myklebust', 'Tangen',
    'Solheim', 'Berge', 'Nygård', 'Dahl', 'Christensen', 'Fossum', 'Bakke', 'Christiansen'
]
