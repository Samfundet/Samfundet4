...
UNIVERSAL_USER_TYPES = {
    'org_recruitment': UserTypeData(
        ...
        name_pattern='{org}_recruitmentmanager',
    ...
    'gang_recruitment': UserTypeData(
        ...
        name_pattern='{org}_{gang}_recruitmentmanager',
        title_nb='Opptaksansvarlig',
        title_en='Recruitment Manager',
        level=GANG_LEVEL,
    ),
    'section_recruitment': UserTypeData(
        ...
        name_pattern='{org}_{gang}_{section}_recruitmentmanager',
        title_nb='Opptaksansvarlig',
        title_en='Recruitment-Manager',
    ...
    'event_manager': UserTypeData(
        roles=[EVENT_MANAGER],
        name_pattern='{org}_{gang}_eventmanager',
    ...
    'venue_manager': UserTypeData(
        roles=[VENUE_MANAGER],
        name_pattern='{org}_{gang}_venuemanager',
    ...
    'vice_gang_leader': UserTypeData(
        ...
        name_pattern='{org}_{gang}_viceleader',
        title_nb='Nestleder',
    ...
    'section_leader': UserTypeData(
        ...
        name_pattern='{org}_{gang}_{section}_sectionleader',
    ...
    'gang_member': UserTypeData(
        roles=[GANG_MEMBER],
        name_pattern='{org}_{gang}_member',
        title_nb='Intern gjengmedlem',
        title_en='Intern gangmember',
        level=GANG_LEVEL,
    ),
}
