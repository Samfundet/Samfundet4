...
def test_has_perm_inactive_user_with_role(
    fixture_role_auth_backend: RoleAuthBackend, fixture_user: User, fixture_organization: Organization,
    fixture_org_permission: Permission, fixture_role: Role
):
...
def test_has_perm_no_obj(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User,
                         fixture_org_permission: Permission):
    assert not fixture_role_auth_backend.has_perm(fixture_user, fixture_org_permission.codename, None)


def test_has_perm_superuser_no_obj(fixture_role_auth_backend: RoleAuthBackend, fixture_superuser: User,
                                   fixture_org_permission: Permission):
    assert not fixture_role_auth_backend.has_perm(fixture_superuser, fixture_org_permission.codename, None)


def test_has_perm_user_with_no_roles(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User, fixture_role: Role,
                                     fixture_organization: Organization, fixture_gang: Gang,
                                     fixture_gang_section: GangSection, fixture_org_permission: Permission,
                                     fixture_gang_permission: Permission, fixture_gang_section_permission: Permission):
    ...
    assert not fixture_role_auth_backend.has_perm(fixture_user, fixture_gang_section_permission.codename,
                                                  fixture_gang_section)


def test_has_perm_user_with_org_role(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User, fixture_role: Role,
                                     fixture_organization: Organization, fixture_org_permission: Permission):
...
def test_has_perm_user_with_gang_role(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User,
                                      fixture_role: Role, fixture_gang: Gang, fixture_gang_permission: Permission):
...
def test_has_perm_user_with_section_role(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User,
                                         fixture_role: Role, fixture_gang_section: GangSection,
    ...
    assert fixture_role_auth_backend.has_perm(fixture_user, fixture_gang_section_permission.codename,
                                              fixture_gang_section)


def test_has_perm_different_orgs(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User,
                                 fixture_organization: Organization, fixture_organization2: Organization,
                                 fixture_org_permission: Permission, fixture_role: Role):
    ...
    assert fixture_role_auth_backend.has_perm(fixture_user, fixture_org_permission.codename, fixture_organization)
    assert not fixture_role_auth_backend.has_perm(fixture_user, fixture_org_permission.codename, fixture_organization2)


def test_has_perm_different_gangs(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User,
                                  fixture_gang: Gang, fixture_gang2: Gang,
                                  fixture_gang_permission: Permission, fixture_role: Role):
    ...
    assert fixture_role_auth_backend.has_perm(fixture_user, fixture_gang_permission.codename, fixture_gang)
    assert not fixture_role_auth_backend.has_perm(fixture_user, fixture_gang_permission.codename, fixture_gang2)


def test_has_perm_different_gang_sections(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User,
                                          fixture_gang_section: GangSection, fixture_gang_section2: Gang,
                                          fixture_gang_section_permission: Permission, fixture_role: Role):
...
def test_has_perm_different_users(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User, fixture_user2: User,
                                  fixture_organization: Organization, fixture_gang: Gang,
                                  fixture_gang_section: GangSection, fixture_org_permission: Permission,
                                  fixture_gang_permission: Permission, fixture_gang_section_permission: Permission,
                                  fixture_role: Role):
    ...
    assert not fixture_role_auth_backend.has_perm(fixture_user2, fixture_org_permission.codename, fixture_organization)
    assert not fixture_role_auth_backend.has_perm(fixture_user2, fixture_gang_permission.codename, fixture_gang)
    assert not fixture_role_auth_backend.has_perm(fixture_user2, fixture_gang_section_permission.codename,
                                                  fixture_gang_section)


def test_has_perm_org_downward(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User,
                               fixture_organization: Organization, fixture_organization2: Organization,
                               fixture_gang: Gang, fixture_gang2: Gang, fixture_gang_section: GangSection,
                               fixture_role: Role, fixture_org_permission: Permission,
                               fixture_gang_permission: Permission, fixture_gang_section_permission: Permission):
...
def test_has_perm_section_upward(fixture_role_auth_backend: RoleAuthBackend, fixture_user: User,
                                 fixture_organization: Organization, fixture_gang: Gang,
                                 fixture_gang_section: GangSection, fixture_role: Role,
                                 fixture_org_permission: Permission, fixture_gang_permission: Permission,
                                 fixture_gang_section_permission: Permission):
