...
def test_has_perm_inactive_user_with_role(
    fixture_role_auth_backend: RoleAuthBackend, fixture_user: User, fixture_organization: Organization, fixture_org_permission: Permission, fixture_role: Role
):
...
def test_has_perm_user_with_org_role(
...
def test_has_perm_user_with_gang_role(
...
def test_has_perm_different_gang_sections(
    ...
    assert fixture_role_auth_backend.has_perm(fixture_user, fixture_gang_section_permission.codename, fixture_gang_section)
    assert not fixture_role_auth_backend.has_perm(fixture_user, fixture_gang_section_permission.codename, fixture_gang_section2)
...
def test_has_perm_different_users(
    ...
    assert not fixture_role_auth_backend.has_perm(fixture_user2, fixture_gang_section_permission.codename, fixture_gang_section)
