...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('samfundet', '0030_organization_recruitment_gang_organization'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interviewers', models.ManyToManyField(help_text='Interviewers for the position', to=settings.AUTH_USER_MODEL)),
