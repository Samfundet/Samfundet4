# Generated by Django 5.0.2 on 2024-06-28 22:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'recruitment',
                    models.ForeignKey(
                        help_text='Which recruitment this occupancy applies to', on_delete=django.db.models.deletion.CASCADE, to='samfundet.recruitment'
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'interviewers',
                    models.ManyToManyField(blank=True, help_text='Interviewers for the position', related_name='interviewers', to=settings.AUTH_USER_MODEL),
                ),
                (
                    'recruitment',
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ManyToManyField(blank=True, help_text='Positions with shared interview', to='samfundet.recruitmentposition'),
                ),
                (
                    'updated_by',
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'recruiter_priority',
                    models.IntegerField(
                        choices=[(0, 'Not Set'), (1, 'Reserve'), (2, 'Wanted'), (3, 'Not Wanted')], default=0, help_text='The priority of the application'
                    ),
                ),
                (
                    'recruiter_status',
                    models.IntegerField(
                        choices=[(0, 'Not Set'), (1, 'Called and Accepted'), (2, 'Called and Rejected'), (3, 'Automatic Rejection')],
                        default=0,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'recipient',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to=settings.AUTH_USER_MODEL, verbose_name='recipient'
                    ),
                ),
                (
                    'target_content_type',
