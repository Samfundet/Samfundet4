# Generated by Django 5.0.2 on 2024-08-21 14:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone_number",
                    samfundet.models.utils.fields.PhoneNumberField(
                        max_length=15, verbose_name="phone_number"
                    ),
                ),
                (
                    "email",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "message_nb",
                    models.TextField(
                        blank=True, null=True, verbose_name="Melding (norsk)"
                    ),
                ),
                (
                    "message_en",
                    models.TextField(
                        blank=True, null=True, verbose_name="Melding (engelsk)"
                    ),
                ),
                (
                    "description_nb",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registered_emails",
                    models.ManyToManyField(
                        blank=True, to="samfundet.nonmemberemailregistration"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_nb",
                    models.CharField(
                        blank=True, max_length=64, null=True, verbose_name="Navn Norsk"
                    ),
                ),
                (
                    "name_en",
                ...
                (
                    "webpage",
                    models.URLField(blank=True, null=True, verbose_name="Nettside"),
                ),
                (
                    "logo",
                    models.ImageField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_nb",
                    models.CharField(
                        blank=True, max_length=64, verbose_name="Navn Norsk"
                    ),
                ),
                (
                    "name_en",
                    models.CharField(
                        blank=True, max_length=64, verbose_name="Navn Engelsk"
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "custom_tickets",
                    models.ManyToManyField(
                        blank=True, to="samfundet.eventcustomticket"
                    ),
                ),
                (
                    "event_group",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="samfundet.eventregistration",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="samfundet.foodcategory",
                    ),
                ),
                (
                    "food_preferences",
                    models.ManyToManyField(blank=True, to="samfundet.foodpreference"),
                ),
                (
                    "updated_by",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "menu_items",
                    models.ManyToManyField(blank=True, to="samfundet.menuitem"),
                ),
            ],
            options={
                "verbose_name": "Menu",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        null=True,
                        verbose_name="Max applications per applicant",
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_date",
                    models.DateField(help_text="First possible date for interviews"),
                ),
                (
                    "end_date",
                    models.DateField(help_text="Last possible date for interviews"),
                ),
                (
                    "start_time",
                    models.TimeField(
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            ...
                            (
                                3,
                                "Another position has this on reserve, with higher priority",
                            ),
                            (
                                4,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_applications",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Total applications"
                    ),
                ),
                (
                    "recruitment",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        blank=True, null=True, upload_to="uploads/saksdokument/"
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="images", to="samfundet.tag"
            ),
        ),
        migrations.CreateModel(
            name="TextItem",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("theme-light", "Light"), ("theme-dark", "Dark")],
                        default="theme-light",
                        max_length=30,
                        null=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "opening",
                    models.TimeField(
                        blank=True, default=datetime.time(8, 0), null=True
                    ),
                ),
                (
                    "closing",
                    models.TimeField(
                        blank=True, default=datetime.time(20, 0), null=True
                    ),
                ),
                (
                    "opening_monday",
