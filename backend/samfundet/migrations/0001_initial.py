    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_open_monday', models.BooleanField(blank=True, default=False, null=True)),
                ('is_open_tuesday', models.BooleanField(blank=True, default=False, null=True)),
                ('is_open_wednesday', models.BooleanField(blank=True, default=False, null=True)),
                ('is_open_thursday', models.BooleanField(blank=True, default=False, null=True)),
                ('is_open_friday', models.BooleanField(blank=True, default=False, null=True)),
                ('is_open_saturday', models.BooleanField(blank=True, default=False, null=True)),
                ('is_open_sunday', models.BooleanField(blank=True, default=False, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='samfundet.image')),
            ],
            options={
                'verbose_name': 'Event',
