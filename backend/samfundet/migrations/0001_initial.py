    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recruiter_status', models.IntegerField(choices=[(0, 'Not Set'), (1, 'Called and Accepted'), (2, 'Called and Rejected'), (3, 'Automatic Rejection')], default=0, help_text='The status of the application')),
