    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occasion', models.CharField(choices=[('DRINK', 'Drikke'), ('EAT', 'Spise')], default='EAT', max_length=24)),
                ...
                ('venue', models.ForeignKey(blank=True, default='Lyche', null=True, on_delete=django.db.models.deletion.CASCADE, to='samfundet.venue', verbose_name='Sted')),
            ],
            options={
