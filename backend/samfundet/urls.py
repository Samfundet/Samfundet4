...
router.register(
    "closed", samfundet.view.general_views.ClosedPeriodView, "closedperiods"
)
router.register("gangs", samfundet.view.general_views.GangView, "gangs")
router.register(
    "gangsorganized", samfundet.view.general_views.GangTypeView, "gangsorganized"
)
router.register(
    "information", samfundet.view.general_views.InformationPageView, "information"
)
router.register("blog", samfundet.view.general_views.BlogPostView, "blog")
router.register(
    "user-preference", samfundet.view.user_views.UserPreferenceView, "user_preference"
)
router.register(
    "saksdokument", samfundet.view.general_views.SaksdokumentView, "saksdokument"
)
...
router.register(
    "food-preference", samfundet.view.sulten_views.FoodPreferenceView, "food_preference"
)
router.register(
    "food-category", samfundet.view.sulten_views.FoodCategoryView, "food_category"
)
...
router.register(
    "organizations", samfundet.view.general_views.OrganizationView, "organizations"
)
...
router.register(
    "recruitment-stats", views.RecruitmentStatisticsView, "recruitment_stats"
)
router.register(
...
router.register(
    "recruitment-position", views.RecruitmentPositionView, "recruitment_position"
)
router.register(
...
router.register(
    "billig-event", billig_views.BilligEventReadOnlyModelViewSet, "billig_event"
)
router.register(
    "billig-price-group",
...
urlpatterns = [
    ...
    path(
        "register/", samfundet.view.user_views.RegisterView.as_view(), name="register"
    ),
