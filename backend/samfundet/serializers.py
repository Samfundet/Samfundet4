...
import itertools
from backend.samfundet.models.utils.image_validation import is_image_valid
...
class UserSerializer(serializers.ModelSerializer):
    ...
    def get_object_permissions(self, user: User) -> list[dict[str, str]]:
        ...
        for obj_perm in itertools.chain(user_object_perms_qs,
            ...
            perm_objs.append(self._obj_permission_to_obj(
                obj_perm=obj_perm))  # noqa: PERF401
...
class RecruitmentPositionSerializer(CustomBaseSerializer):
    ...
    def update(self, instance: RecruitmentPosition,
               validated_data: dict) -> RecruitmentPosition:  # noqa: PLR0917
...
class AdmissionFileUploadSerializer(CustomBaseSerializer):

    class Meta:
        model = AdmissionFileUpload
...
class RecruitmentAdmissionForGangSerializer(CustomBaseSerializer):
    ...
    def update(self, instance: RecruitmentAdmission,
               validated_data: dict) -> RecruitmentAdmission:  # noqa: PLR0917
