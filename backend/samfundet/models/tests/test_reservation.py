...
class TestReservation:
    def test_check_fetches_times(
        ...
        full_date = Reservation.fetch_available_times_for_date(venue=fixture_venue.slug, date=fixture_date_tuesday, seating=3)
    ...
    def test_check_too_high_seating(
        ...
        full_date = Reservation.fetch_available_times_for_date(venue=fixture_venue.slug, date=fixture_date_monday, seating=100)
        assert len(full_date) == 0
    ...
    def test_check_filter_out_hours(
        ...
        full_date = Reservation.fetch_available_times_for_date(venue=fixture_venue.slug, date=fixture_date_tuesday, seating=3)
        occupied_date = Reservation.fetch_available_times_for_date(venue=fixture_venue.slug, date=fixture_date_monday, seating=3)
