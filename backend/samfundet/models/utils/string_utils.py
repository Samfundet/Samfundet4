...
from samfundet.models.recruitment import ApplicationFileAttachment
...
def upload_to_application_filepath(instance: ApplicationFileAttachment, filename: str) -> str:
