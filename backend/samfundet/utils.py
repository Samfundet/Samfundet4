...
def venue_to_dataclass(*, venue: Venue) -> VenueDto:
    return VenueDto(
        ...
        opening_monday=venue.opening_monday,
        opening_tuesday=venue.opening_tuesday,
        opening_wednesday=venue.opening_wednesday,
        opening_thursday=venue.opening_thursday,
        opening_friday=venue.opening_friday,
        opening_saturday=venue.opening_saturday,
        opening_sunday=venue.opening_sunday,
        closing_monday=venue.closing_monday,
        closing_tuesday=venue.closing_tuesday,
        closing_wednesday=venue.closing_wednesday,
        closing_thursday=venue.closing_thursday,
        closing_friday=venue.closing_friday,
        closing_saturday=venue.closing_saturday,
        closing_sunday=venue.closing_sunday,
        is_open_monday=venue.is_open_monday,
        is_open_tuesday=venue.is_open_tuesday,
        is_open_wednesday=venue.is_open_wednesday,
        is_open_thursday=venue.is_open_thursday,
        is_open_friday=venue.is_open_friday,
        is_open_saturday=venue.is_open_saturday,
        is_open_sunday=venue.is_open_sunday,
    )
